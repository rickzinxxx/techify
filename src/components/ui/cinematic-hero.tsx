    ...
    const ctx = gsap.context(() => {
      ...
      const scrollTl = gsap.timeline({
        scrollTrigger: {
          ...
          start: "top top",
          end: isMobile ? "+=1000" : "+=2000", // Significantly reduced scroll distance for both mobile and desktop
          pin: true,
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        <h1 className="text-track gsap-reveal text-3d-matte text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight mb-2">
          {tagline1}
        </h1>
        <h1 className="text-days gsap-reveal text-silver-matte text-3xl md:text-4xl lg:text-5xl font-extrabold tracking-tighter">
          {tagline2}
        </h1>
      </div>

      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-6 tracking-tight text-silver-matte">
          {ctaHeading}
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <button className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group">
            <span className="text-xl font-bold">Criar Site Agora</span>
          </button>
          <button className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem] group">
            <span className="text-xl font-bold">Ver Portfólio</span>
          </button>
        </div>
      </div>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            <div className="card-right-text gsap-reveal order-1 lg:order-3 flex justify-center lg:justify-end z-20 w-full">
              <h2 className="text-4xl md:text-[4rem] lg:text-[5rem] font-black uppercase tracking-tighter text-card-silver-matte lg:mt-0">
                {brandName}
              </h2>
            </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Live Stats</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Dashboard</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">T</div>
                      </div>
                      ...
                      <div className="phone-widget relative w-44 h-44 mx-auto flex items-center justify-center mb-8 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        ...
                        <div className="text-center z-10 flex flex-col items-center">
                          ...
                          <span className="text-[8px] text-brand/50 uppercase tracking-[0.1em] font-bold mt-0.5">{metricLabel}</span>
                        </div>
                      </div>

                      <div className="space-y-3">
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-brand/10 flex items-center justify-center mr-3 border border-brand/20">
                            <span className="text-brand text-xs">A+</span>
                          </div>
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-orange-500/10 flex items-center justify-center mr-3 border border-orange-400/20">
                            <span className="text-orange-400 text-xs">99ms</span>
                          </div>
                          <div className="flex-1">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-brand/10 flex items-center justify-center border border-brand/30">
                    <span className="text-base lg:text-xl drop-shadow-lg">🚀</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Imersão Total</p>
                    <p className="text-gray-400 text-[10px] lg:text-xs">WebGL & 3D Core</p>
                  </div>
                </div>

                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-indigo-500/10 flex items-center justify-center border border-indigo-400/30">
                    <span className="text-base lg:text-lg drop-shadow-lg">⚡</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Alta Performance</p>
                    <p className="text-gray-400 text-[10px] lg:text-xs">SEO Optimized</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="hidden md:block text-gray-400 text-sm md:text-base lg:text-lg font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
